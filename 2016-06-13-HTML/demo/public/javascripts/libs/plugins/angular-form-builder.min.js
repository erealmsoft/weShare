    ...
    angular.module('builder.controller', ['builder.provider']).controller('fbFormObjectEditableController', [
        '$scope', '$injector', function($scope, $injector) {
            ...
            $scope.setupScope = function(formObject) {
                ...
                $scope.optionsText = JSON.stringify(formObject.options);
        ...
        '$scope', '$injector', function($scope, $injector) {
            ...
            return $scope.$watchCollection('allComponents', function() {
                $scope.activeGroup || ($scope.activeGroup = $scope.groups[0])
...
(function() {
    angular.module('builder.directive', ['builder.provider', 'builder.controller', 'builder.drag', 'validator']).directive('fbBuilder', [
        ...
        return {
            restrict: 'A',
            template: "<ul ng-if=\"groups.length > 1\" class=\"nav nav-tabs nav-justified\">\n    <li ng-repeat=\"group in groups\" ng-class=\"{active:activeGroup==group}\">\n        <a href='#' ng-click=\"selectGroup($event, group)\">{{group}}</a>\n    </li>\n</ul>\n<div class='form-horizontal'>\n    <div class='fb-component col-sm-12' ng-show='!component.hide' ng-repeat=\"component in components | orderBy:'label'\"\n        fb-component=\"component\"></div>\n</div>",
            controller: 'fbComponentsController'
        };
        ...
        '$injector', function($injector) {
            ...
            return {
                ...
                link: function(scope, element) {
                    ...
                    return scope.$watch('component.optionTemplate', function(template) {
                        var view;
                        if (!template) {
                            return;
                        }
    ...
    angular.module('builder.provider', []).provider('$builder', function() {
        ...
        this.convertComponent = function(name, component) {
            ...
            result = {
                ...
                optionTemplate: component.optionTemplate||component.template,
        ...
        this.hideComponent = (function(_this) {
            return function(componentName) {
                _this.components[componentName] && (_this.components[componentName].hide = true)
            };
        })(this);
        this.showComponent = (function(_this) {
            return function(componentName) {
                _this.components[componentName] && (_this.components[componentName].hide = false)
            };
        })(this);
        ...
        this.insertFormObject = (function(_this) {
            return function(name, index, formObject) {
                ...
                _this.hideComponent(formObject.component);
        ...
        this.removeFormObject = (function(_this) {
            return function(name, index) {
                ...
                var formObjects;
                formObjects = _this.forms[name];
                _this.showComponent(formObjects[index].component);
                formObjects.splice(index, 1);

                return _this.reindexFormObject(name);
            };
        })(this);
        this.resetFormObjects = (function(_this) {
            return function(name) {
                ...
                /*
                 ...
                 @param index: The form object index.
                 */
                var formObjects, len = _this.forms[name].length;

                for (var i=len-1; i>=0; i--) {
                    _this.removeFormObject(name, i);
                }
            ...
            '$injector', (function(_this) {
                return function($injector) {
                    ...
                    return {
                        ...
                        hideComponent: _this.hideComponent,
                        showComponent: _this.showComponent,
                        addFormObject: _this.addFormObject,
                        resetFormObjects: _this.resetFormObjects,
